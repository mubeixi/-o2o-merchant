			...
			<div class="container">
				<el-tabs v-model="innerDialog.index" tab-position="left" class="leftMenuEl">
					...
					<el-tab-pane label="跳转微信小程序" name="mini" :disabled="!config.mini.show">
						<div class="line10">
							<el-input v-model="innerDialog.mini.innerText" placeholder="在此输入链接地址"></el-input>
						</div>
						<div class="line10">
							<el-input v-model="innerDialog.mini.appid" placeholder="在此输入小程序appid（小程序跳转)"></el-input>
						</div>
						<div class="line10">
							<el-input v-model="innerDialog.mini.origin_id" placeholder="在此输入小程序原始id(app跳转)"></el-input>
						</div>
						<div class="line10">
							<el-input v-model="innerDialog.mini.url" placeholder="在此输入备用跳转地址(低版本时将跳转到此网址)"></el-input>
						</div>
					</el-tab-pane>
  ...
  methods: {
    ...
    selectPage () {
      ...
      if (this.innerDialog.index === 'customize') {
        ...
        type = 'mini'
        dataItem = {
          url: this.innerDialog.mini.url,
          appid: this.innerDialog.mini.appid,
          origin_id: this.innerDialog.mini.origin_id,
        }

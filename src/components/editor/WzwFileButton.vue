<template>
	...
	<div>
		<input @change="fileFn($event)" :multiple="multiple" :id="elIdName" :name="elIdName" :accept="acceptStr" type="file"
		       class="input-comp-file" />
...
import {createToken, GET_ACCESS_TOKEN, get_Users_ID, getAliyunOssSign} from '../../common/fetch'

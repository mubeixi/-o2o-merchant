<template>
	<div class="wrap">
		<div class="title">
			<div :class="item==1?'active':''" @click="changeItem(1)" class="item">用户详情</div>
			<div :class="item==2?'active':''" @click="changeItem(2)" class="item">登录日志</div>
			<div :class="item==3?'active':''" @click="changeItem(3)" class="item">积分明细</div>
			<div :class="item==4?'active':''" @click="changeItem(4)" class="item">资金流水</div>
			<div :class="item==5?'active':''" @click="changeItem(5)" class="item">成长值明细</div>
		</div>
		<div class="content">
			<div style="background: #fff;width: 100%;">
				<template v-if="item ==1">
					...
					<div class="user-msg-wrap">
						<div class="user-msg">
							<div class="user-left">
								<img :src="userInfo.User_HeadImg" alt="" class="user-avator">
								<div class="user-phone">{{userInfo.User_Mobile}}</div>
								<div class="user-level">{{userInfo.level_name}}</div>
							</div>
							<div class="user-right">
								<table cellpadding="0" cellspacing="0" class="width:100%;height: 100%;color:#666;">
									<tr class="first">
										<td>手机</td>
						...
						>
							...
							width="148">
								<template slot-scope="scope">
									<el-button @click="handleClick(scope,orderData)" size="small" type="text">查看订单
									</el-button>
								</template>
							</el-table-column>
						</el-table>
				...
				<template v-if="item !=1">
					<div class="condition">
						<template v-if="des[item]">
							...
							<el-select :placeholder="'请选择'+des[item]+'来源'" popper-class="my-select"
							           v-model="type">
								<el-option
								:key="index"
								:label="item"
						...
						<el-button @click="query" class="query" type="primary">查询</el-button>
						<el-button @click="query('output')" class="export" type="primary" v-if="item != 2">
							导出数据
						</el-button>
					</div>
				</template>
